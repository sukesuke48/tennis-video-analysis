...
def add_relative_landmark_fields(row, name, norm_xy, px_xy, base_norm_xy, base_px_xy, width, height):
    if norm_xy is None or base_norm_xy is None:
        row[f"{name}_base_right_heel_x"] = None
        row[f"{name}_base_right_heel_y"] = None
    else:
        row[f"{name}_base_right_heel_x"] = float(norm_xy[0] - base_norm_xy[0])
        row[f"{name}_base_right_heel_y"] = float(norm_xy[1] - base_norm_xy[1])
...
def extract_pose_row_data(landmarks, width, height):
    ...
    for name, _ in landmark_names:
        add_relative_landmark_fields(
            row=row,
            name=name,
            norm_xy=landmark_norm_map[name],
            px_xy=landmark_px_map[name],
            base_norm_xy=right_heel,
    ...
    shoulder_center_rel = relative_point(shoulder_center, right_heel)
    hip_center_rel = relative_point(hip_center, right_heel)

    row["pose_visible"] = 1
    row["position_base_name"] = "right_heel"
    row["base_right_heel_px_x"] = right_heel_px[0] if right_heel_px is not None else None
    row["base_right_heel_px_y"] = right_heel_px[1] if right_heel_px is not None else None
    row["base_right_heel_x"] = right_heel[0] if right_heel is not None else None
    row["base_right_heel_y"] = right_heel[1] if right_heel is not None else None
    ...
    row["hip_center_base_right_heel_x"] = hip_center_rel[0] if hip_center_rel is not None else None
    row["hip_center_base_right_heel_y"] = hip_center_rel[1] if hip_center_rel is not None else None
    row["shoulder_center_base_right_heel_x"] = shoulder_center_rel[0] if shoulder_center_rel is not None else None
    row["shoulder_center_base_right_heel_y"] = shoulder_center_rel[1] if shoulder_center_rel is not None else None
...
def add_empty_pose_fields(row):
    keys = [
        ...
        "base_right_heel_x", "base_right_heel_y",
        ...
        "hip_center_base_right_heel_x", "hip_center_base_right_heel_y",
        "shoulder_center_base_right_heel_x", "shoulder_center_base_right_heel_y",
        ...
        "nose_base_right_heel_x", "nose_base_right_heel_y",
        "left_shoulder_base_right_heel_x", "left_shoulder_base_right_heel_y",
        "right_shoulder_base_right_heel_x", "right_shoulder_base_right_heel_y",
        "left_elbow_base_right_heel_x", "left_elbow_base_right_heel_y",
        "right_elbow_base_right_heel_x", "right_elbow_base_right_heel_y",
        "left_wrist_base_right_heel_x", "left_wrist_base_right_heel_y",
        "right_wrist_base_right_heel_x", "right_wrist_base_right_heel_y",
        "left_index_base_right_heel_x", "left_index_base_right_heel_y",
        "right_index_base_right_heel_x", "right_index_base_right_heel_y",
        "left_hip_base_right_heel_x", "left_hip_base_right_heel_y",
        "right_hip_base_right_heel_x", "right_hip_base_right_heel_y",
        "left_knee_base_right_heel_x", "left_knee_base_right_heel_y",
        "right_knee_base_right_heel_x", "right_knee_base_right_heel_y",
        "left_ankle_base_right_heel_x", "left_ankle_base_right_heel_y",
        "right_ankle_base_right_heel_x", "right_ankle_base_right_heel_y",
        "left_heel_base_right_heel_x", "left_heel_base_right_heel_y",
        "right_heel_base_right_heel_x", "right_heel_base_right_heel_y",
